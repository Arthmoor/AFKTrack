...
class Akismet
{
	...
	public function isKeyValid()
	{
		...
		$response = $this->sendRequest('key=' . $this->wordPressAPIKey . '&blog=' . $this->trackURL, $this->akismetServer, '/' . $this->akismetVersion . '/verify-key');
	...
	private function sendRequest($request, $host, $path)
	{
		...
		$http_request .= "User-Agent: AFKTrack/" . $this->version . " | Akismet/" . $this->akismetVersion . "\r\n";
		$http_request .= "\r\n";
