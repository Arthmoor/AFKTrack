...
break;
	...
	case 2:
		  ...
		  <div class='title'>New AFKTrack Installation</div>";
			...
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':alien:', 'alien.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':biggrin:', 'biggrin.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':blues:', 'blues.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':cool:', 'cool.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':cry:', 'cry.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':cyclops:', 'cyclops.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':devil:', 'devil.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':evil:', 'evil.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':ghostface:', 'ghostface.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':grinning:', 'grinning.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':lol:', 'lol.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':mad:', 'angry.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':redface:', 'redface.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':robot:', 'robot.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':rolleyes:', 'rolleyes.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':sad:', 'sad.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':smile:', 'smile.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':stare:', 'stare.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':surprised:', 'surprised.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':thinking:', 'thinking.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':tongue:', 'tongue.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':unclesam:', 'unclesam.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':wink:', 'wink.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':huh:', 'huh.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':blink:', 'blink.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':facepalm:', 'facepalm.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':whistle:', 'whistle.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':sick:', 'sick.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':headbang:', 'headbang.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':innocent:', 'innocent.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':crazy:', 'crazy.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':rofl:', 'rofl.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':lmao:', 'lmao.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':shrug:', 'shrug.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':ninja:', 'ninja.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':nuke:', 'nuke.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':wub:', 'wub.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':imp:', 'imp.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':banana:', 'dancingbanana.gif', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':cricket:', 'cricket.png', 1 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':(', 'sad.png', 0 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':P', 'tongue.png', 0 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (';)', 'wink.png', 0 )" );
			$this->db->dbquery( "INSERT INTO %pemoji (emoji_string, emoji_image, emoji_clickable) VALUES (':)', 'smile.gif', 0 )" );
